...
function validate8(){
    ...
    unamenode.style.border="3px solid dark red";
    return false;
    }
    else if(usernamepattern.test(uname)){
        spannode8.innerHTML="It should contain alphanumeric value";
        unamenode.style.border="3px solod red";
    }
    else
    {
